 ...
 * @author DELL
 */
public class button_traPhong extends javax.swing.JFrame {

    /**
     * Creates new form main_taiKhoan
     */
    public button_traPhong() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(button_traPhong.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new button_traPhong().setVisible(true);
            }
        });
    }
