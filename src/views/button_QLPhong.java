 ...
 * @author DELL
 */
public class button_QLPhong extends javax.swing.JFrame {

    /**
     * Creates new form main_taiKhoan
     */
    public button_QLPhong() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(button_QLPhong.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new button_QLPhong().setVisible(true);
            }
        });
    }
