 ...
 * @author DELL
 */
public class button_datPhong extends javax.swing.JFrame {

    /**
     * Creates new form main_taiKhoan
     */
    public button_datPhong() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(button_datPhong.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new button_datPhong().setVisible(true);
            }
        });
    }
